...
hi Cursor gui=none guibg=Orange guifg=Black

hi Folded term=standout ctermfg=11 ctermbg=8 guifg=#2E6836 guibg=#2E3436 
" No fold column support yet
" hi FoldColumn guifg=Orange guibg=DarkBlue
" =============================================================================
" Syntax highlighting
" =============================================================================
"hi def cCustomFunc  guifg=#9BCF8D
hi def cCustomFunc  guifg=#729FC0
"hi def cCustomClass gui=underline guifg=#729FCF
...
hi ColorColumn ctermbg=White guibg=#2E3836
